...
<body>
    ...
    <main>
        ...
        <form action="contactinfo">
            ...
            <input type="text" name="naam" placeholder="Femke Hart">

            <label for="tel">
                <br>Telefoonnummer</br>
            </label>
            <input type="text" name="nummer" placeholder="0612345678">
            ...
            <input type="text" name="email" placeholder="femkehart@hotmail.com">
