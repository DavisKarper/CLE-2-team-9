...
if(isset($_POST['submit'])) {
    ...
    if ($_POST['firstName'] == ''){
        $errors['firstName'] = 'You have to fill in your first name';
    } else{
        $errors['firstName'] = ' ';
    }
    if ($_POST['lastName'] == ''){
        $errors['lastName'] = 'You have to fill in your last name';
    } else{
        $errors['lastName'] = ' ';
    }
    if ($_POST['email'] == ''){
        $errors['email'] = 'You have to fill in your email';
    }else{
        $errors['email'] = ' ';
    }
    if ($_POST['password'] == ''){
        $errors['password'] = 'You have to fill in your password';
    } else{
        $errors['password'] = ' ';
    }
    // If data valid
